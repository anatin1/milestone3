...
var app = {
    ...
    onDeviceReady: function() {
		app.events = util.store('events');
		app.loadTemplates();
        app.render('container', 'entries', {});
	...
	route: function(path){
		...
		if(/\/entries\/(\d*)/.test(path)){
			...
			console.log(id);
			app.render('container', 'entry', {event: app.events[id]});
			return
		}
		app.render('container', 'entries', {events: app.events});
	},
